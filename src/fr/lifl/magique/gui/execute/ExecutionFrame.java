...
public class ExecutionFrame extends JInternalFrame {
    ...
    private final JScrollPane bar1;
    private final JScrollPane bar2;
    private final JDisplay canevas = new JDisplay();
    private final JTabbedPane onglet = new JTabbedPane();
    private boolean ishidden = false;
    private final GraphicAgent root;
    ...
    public ExecutionFrame(GraphicAgent root, Container desktop) {
        ...
        JMenu menu1 = menuBar.add(new JMenu("View"));
        JMenuItem item1_1 = menu1.add(new JMenuItem("reset"));
        ...
        follow.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                isFollowing = e.getStateChange() == ItemEvent.SELECTED;
            }
        });
        setFrameIcon(rouge);
        this.root = root;
