...
public class Node extends JComponent {
    ...
    public boolean addSpecialParent(Node Parent) {
        ...
        VSpecialParent.addElement(Parent);
        return true;
    }
    ...
    public boolean addSpecialChild(Node Child) {
        ...
        VSpecialChild.addElement(Child);
        return true;
    }
     ...
     */
    public Vector getSpecialParent() {
        return VSpecialParent;
    }
     ...
     */
    public Vector getSpecialChildren() {
        return VSpecialChild;
    }
     ...
     */
    public void removeSpecialParent(Node parent) {
        VSpecialParent.remove(parent);
    }
     ...
     * @param child the Node to be removed
     */
    public void removeSpecialChild(Node child) {
        VSpecialChild.remove(child);
    }
     ...
     * <code>false</code> otherwise
     */
    public boolean hasAlreadyParent() {
        return (parent != null);
    }
