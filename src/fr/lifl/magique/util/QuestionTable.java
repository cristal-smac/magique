...
public class QuestionTable extends Hashtable {
	...
	private ConcurrencyPolicy theConcurrencyPolicy = new DefaultConcurrencyPolicy();
	...
	public synchronized Answer selectTheAnswer(String question) {
		...
		//	System.out.println("avant wait selectTheAnswer");
		...
		//	System.out.println("après wait selectTheAnswer");
	...
	public synchronized void setAnAnswer(String question, Object answer, String answerer, int pathLength) {
		...
		notifyAll();
		//System.out.println("NOTIFY DONE selectTheAnswer");
