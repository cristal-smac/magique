...
import fr.lifl.magique.gui.file.ClassFilesFilter;
import fr.lifl.magique.gui.file.DirectoryFilter;
import fr.lifl.magique.gui.file.JarFilesFilter;
...
public class TreeCreator {
     ...
     */
    public TreeCreator(StreamTokenizer st) {
        comp = st;
    }
     ...
     */
    public TreeCreator(String path) {
        pathrac = path;
    }
    ...
    public JTree createClassesTree() {
        ...
        DefaultMutableTreeNode dir = new DefaultMutableTreeNode("..", true);
        root.add(dir);
    ...
    public void createClassesHierarchy(TreePath treepath, JTree t) {
        ...
        String[] Res1 = Fich.list(filtre1);
        String[] Res2 = Fich.list(filtre2);
        String[] Res3 = Fich.list(filtre3);
        String tmp;
        Arrays.sort(Res1);
        Arrays.sort(Res2);
        Arrays.sort(Res3);
        ...
        for (int i = 0; i < Res2.length; i++) {
            ...
            while (!node.toString().equals(pathrac)) {
                name = node + System.getProperty("file.separator") + name;
