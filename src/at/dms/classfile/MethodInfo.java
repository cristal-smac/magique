    ...
    extends Member
{
                      ...
                      boolean synthetic)
    {
        ...
        this.attributes =
            new AttributeList(code,
                              exceptions != null
                              && exceptions.length != 0
                              ? new ExceptionsAttribute(exceptions) : null,
    ...
    public String[] getExceptions()
    {
        ...
        return attr == null
            ? null : ((ExceptionsAttribute)attr).getExceptions();
    }
        ...
        throws ClassFileFormatException
    {
        try {
            ...
            System.err.println("name: " + name.getValue());
            System.err.println("type: " + type.getValue());
            throw e;
        }
    }
     ...
     *
     * @exception ClassFileFormatException
     * Attempt to write a bad classfile.
     */
    ...
    protected int getParameterCount()
    {
        ...
        if ((getModifiers() & ACC_STATIC) == 0) {
            // an instance method always passes "this" as first,
            // hidden parameter
            paramCnt += 1;
        }
