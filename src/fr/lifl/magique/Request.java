...
public class Request 
    ...
    public String getSender() { return (String) path.firstElement(); }
    ...
    public boolean getIsQuestion() { return isQuestion.booleanValue(); }
    /** @return <em>true</em> if it is a concurrent request */
    public boolean isConcurrent() { return concurrent.booleanValue(); }
    ...
    public void setConcurrent() { concurrent = Boolean.TRUE; }
