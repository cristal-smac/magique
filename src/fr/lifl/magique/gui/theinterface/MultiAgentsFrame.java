...
import fr.lifl.magique.gui.tree.*;
import fr.lifl.magique.gui.file.*;
import fr.lifl.magique.gui.execute.*;
import fr.lifl.magique.gui.network.*;
...
public class MultiAgentsFrame extends JFrame {
	...
	private JMenuBar CreateMenuBar() {
		...
		JMenu menu1 = (JMenu) menuBar.add(new JMenu(lang[0]));
		menu1.setMnemonic(lang[0].charAt(0));
		JMenuItem item1_1 = (JMenuItem) menu1.add(new JMenuItem(lang[1]));
		...
		JMenuItem item1_2 = (JMenuItem) menu1.add(new JMenuItem(lang[2]));
		...
		JMenuItem item1_3 = (JMenuItem) menu1.add(new JMenuItem(lang[3]));
		...
		JMenuItem item1_4 = (JMenuItem) menu1.add(new JMenuItem(lang[4]));
		...
		JMenuItem item1_5 = (JMenuItem) menu1.add(new JMenuItem(lang[5]));
		...
		JMenuItem item1_6 = (JMenuItem) menu1.add(new JMenuItem(lang[6]));
		...
		JMenu menu2 = (JMenu) menuBar.add(new JMenu(lang[7]));
		...
		cb[0].addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (cb[0].isSelected())
					AgentsTree.setVisible(true);
				else
					AgentsTree.setVisible(false);
			}
		});
		...
		cb[2].addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (cb[2].isSelected())
					AgentClasses.setVisible(true);
				else
					AgentClasses.setVisible(false);
			}
		});
		...
		cb[3].addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (cb[3].isSelected())
					...
					AgentProperties.setVisible(false);
			}
		});
		...
		JMenu menu3 = (JMenu) menuBar.add(new JMenu(lang[12]));
		menu3.setMnemonic(lang[12].charAt(0));
		JMenu Col = (JMenu) menu3.add(new JMenu(lang[13]));

		JMenuItem item3_1 = (JMenuItem) Col.add(new JMenuItem(lang[14]));
		...
		JMenuItem item3_2 = (JMenuItem) Col.add(new JMenuItem(lang[15]));
		...
		JMenuItem item3_3 = (JMenuItem) Col.add(new JMenuItem(lang[16]));
		...
		JMenuItem item3_4 = (JMenuItem) Col.add(new JMenuItem(lang[17]));
		...
		JMenuItem item3_5 = (JMenuItem) Col.add(new JMenuItem(lang[54]));
		...
		JMenuItem item3_6 = (JMenuItem) Col.add(new JMenuItem(lang[18]));
		...
		JMenuItem item4_1 = (JMenuItem) icon.add(new JMenuItem(lang[24]));
		...
		menu3.addSeparator();
		JMenuItem item5_1 = (JMenuItem) menu3.add(new JMenuItem(lang[33]));
	...
	class ExecutorFrame extends JFrame {
		private Deployement execute;
		private JMenuBar menuBar = new JMenuBar();
		// private JVMInputServer streamServer;
		private JDesktopPane desktop2 = new JDesktopPane();
		JMenu menu2 = null;
		JMenu menu3 = null;
		JMenu menu4 = null;
		...
		private JMenuBar CreateMenuBar() {
			JMenu menu1 = (JMenu) menuBar.add(new JMenu("Config"));
			JMenuItem item1_1 = (JMenuItem) menu1.add(new JMenuItem("load"));
			item1_1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					MagicFilesChooser chooser = new MagicFilesChooser(0, filechooserdirectory);
			...
			JMenuItem item1_2 = (JMenuItem) menu1.add(new JMenuItem("edit"));
			item1_2.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
			...
			menu3 = (JMenu) menuBar.add(new JMenu("show"));
			menu3.addMenuListener(new MenuListener() {
				public void menuSelected(MenuEvent e) {
					...
					for (Enumeration h = execute.getConfigs(); h.hasMoreElements();) {
						...
						JMenuItem tmp3 = (JMenuItem) tmp.add(new JMenuItem("Show Config"));
						JMenuItem tmp4 = (JMenuItem) tmp.add(new JMenuItem("Hide Config"));
						JMenuItem tmp5 = (JMenuItem) tmp.add(new JMenuItem("Show All Agents"));
	...
	class ComputersFrame extends JInternalFrame {
		...
		private PortFrame portframe = new PortFrame(edition);
					...
					if (selRow != -1) {
						...
						if (SwingUtilities.isRightMouseButton(e)) {
							...
							if (!node.getAllowsChildren()) {
								...
								JMenuItem jMenu0_1 = (JMenuItem) popup0.add(new JMenuItem("setPort"));
		...
		private Hashtable getAllComputers(DefaultMutableTreeNode pere, String current, Hashtable Vnom_machines) {
			...
			if (pere.getAllowsChildren()) {
				nouveau = new String("." + pere.toString() + current);
		...
		private JMenuBar CreateMenuBar() {
			JMenuBar menuBar = new JMenuBar();
			JMenu menu2 = (JMenu) menuBar.add(new JMenu("File"));
			JMenu menu1 = (JMenu) menuBar.add(new JMenu("edit"));
			JMenu menu3 = (JMenu) menuBar.add(new JMenu("Net"));
			JMenu menu1b = (JMenu) menu1.add(new JMenu("insert"));
			JMenuItem item1_1 = (JMenuItem) menu1b.add("computer");
			JMenuItem item1_2 = (JMenuItem) menu1b.add("domain");
			JMenuItem item1_3 = (JMenuItem) menu1.add("delete");
			JMenuItem item2_1 = (JMenuItem) menu2.add("reload");
			JMenuItem item2_2 = (JMenuItem) menu2.add("save");
			JMenuItem item3_1 = (JMenuItem) menu3.add("reTest");
	...
	class AgentClassesFrame extends JInternalFrame {
		...
		private JTextField racine = new JTextField(20);
		private String pathrac, CurrentClass = "", ClassPath = "", pathbak = ".";
		private JButton browse = new JButton(lang[49]);
		private JScrollPane bar = new JScrollPane(), meth = new JScrollPane();
		private JPanel panel = new JPanel();
		private JInternalFrame frame = new JInternalFrame("", false, false, false, false);
		 ...
		 *
		 * @param path
		 *            the new path to use as the directory root
		 */
						...
						if (!isSelected() || !classes.hasFocus()) {
							...
							if (selRow != -1) {
								...
								if (node.toString().equals("..")) {
									String upperdirectory = new String(pathbak);
								...
								if (nodetmp != null) {
									while (!nodetmp.toString().equals(classes.getModel().getRoot().toString())) {
										ClassPath = nodetmp.toString() + System.getProperty("file.separator")
												+ ClassPath;
										nodetmp = (DefaultMutableTreeNode) nodetmp.getParent();
									}
								}
	...
	class SkillFrame extends JDialog {
		...
		private JScrollPane bar = new JScrollPane(), bar2 = new JScrollPane();
		private JPanel panel0 = new JPanel(), panel1 = new JPanel();
		private JPanel panel2 = new JPanel(), panel3 = new JPanel(), panel4 = new JPanel(), panel5 = new JPanel();
			...
			Ok.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (liste.getSelectedValue() != null)
						constructor = ((Constructor) liste.getSelectedValue()).toString();
					reportSkill();
					setVisible(false);
				}
			});
		...
		public void reportSkill() {
			if (isValid())
				AgentsTree.addSkill(new SkillDescriptor(CurrentClass, ClassPath, (((Constructor) liste
				...
				classes.addMouseListener(new MouseAdapter() {
					public void mousePressed(MouseEvent e) {
						...
						if (selRow != -1) {
							...
							if (nodetmp != null) {
								while (!nodetmp.toString().equals(classes.getModel().getRoot().toString())) {
									ClassPath = nodetmp.toString() + System.getProperty("file.separator") + ClassPath;
									nodetmp = (DefaultMutableTreeNode) nodetmp.getParent();
								}
							}
							if (pathrac.endsWith(System.getProperty("file.separator")))
	...
	class AgentPropertiesFrame extends JInternalFrame {
		private JScrollPane bar = new JScrollPane(), bar2 = new JScrollPane();
		private JPanel panel = new JPanel(), skillPanel = new JPanel(), initPanel = new JPanel(),
				skillGeneralPanel = new JPanel();
		private JButton bname, bclass, bcomputer, sadd, sremove;
		private JTextField tname, tclass, tcomputer;
		private Vector VBinit = new Vector(), VTinit = new Vector(), VBSinit = new Vector(), VTSinit = new Vector();
		private int nrow = 3;
			...
			tclass.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (pt != -1) {
						...
						classe = classe.substring(pt + 1, classe.length());
					}
		 ...
		 * 
		 * @param a
		 *            boolean to indicate if active or not
		 ...
		 * 
		 * @param name
		 *            a string that indicate the name to set
		 ...
		 * 
		 * @param classe
		 *            a string that indicate the class to set
		 * @see java.awt.TextField#setText
		 */
		 ...
		 * 
		 * @param computer
		 *            a string that indicate the computer to set
		 * @see java.awt.TextField#setText
		 */
		 ...
		 * 
		 * @param Init
		 *            a vector containing the initialisers functions of the
		 *            agent
		 */
		...
		public void addInit(Vector Init) {
			...
			if (Init != null) {
				for (int i = 0; i < Init.size(); i++) {
					...
					if (p2 != -1)
						init1 = init1.substring(0, p1 + 1) + init1.substring(p2 + 1, init1.length());
	...
	class AgentsTreeFrame extends JInternalFrame {
		 ...
		 *
		 * @param C
		 *            the new direct link color to be set
		 */
		 ...
		 *
		 * @param C
		 *            the new selection color to be set
		 */
		 ...
		 *
		 * @param name
		 *            the new name of the selected agent
		 */
		public void setName(String name) {
		 ...
		 *
		 * @param name
		 *            the new class of the selected agent(s)
		 */
		 ...
		 *
		 * @param name
		 *            the new classpath of the selected agent(s)
		 */
		 ...
		 *
		 * @param name
		 *            the new computer of the selected agent(s)
		 */
		public void setComputer(String computer) {
		 ...
		 * @param arg
		 *            the function initialiser argument
		 */
		 ...
		 *
		 * @param classpath
		 *            the class path of the agent's class
		 * @param classe
		 *            the agent class
		 ...
		 *
		 * @param func
		 *            the function whose argument is requested
		 ...
		 *
		 * @param computer
		 *            the computer where the agents are
		 */
		 ...
		 * @param reset
		 *            a boolean to indicate whether or not the current
		 ...
		 *
		 * @param Filename
		 *            the name of the file where the configuration is going to
		 *            be saved
		 */
	...
	class TreeDrawing extends JComponent {
		...
		private float[] motif = { 5.0f };
		private BasicStroke pointille = new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 5.0f,
				motif, 0.0f);
				...
				public void mousePressed(MouseEvent e) {
					...
					if (SwingUtilities.isRightMouseButton(e)) {
						...
						case 0:
							...
							if (cb[7].isSelected()) {
								JMenuItem jMenu0_1 = (JMenuItem) popup0.add(new JMenuItem(lang[30]));
								jMenu0_1.addActionListener(new ActionListener() {
									public void actionPerformed(ActionEvent e) {
								...
								JMenuItem jMenu0_1 = (JMenuItem) popup0.add(new JMenuItem(lang[29]));
								jMenu0_1.addActionListener(new ActionListener() {
									public void actionPerformed(ActionEvent e) {
							...
							if (!cb[6].isSelected()) {
								JMenuItem jMenu0_2 = (JMenuItem) popup0.add(new JMenuItem(lang[27]));
								...
								JMenuItem jMenu0_2 = (JMenuItem) popup0.add(new JMenuItem(lang[28]));
								jMenu0_2.addActionListener(new ActionListener() {
									public void actionPerformed(ActionEvent e) {
										AgentsTree.setSmallIcons(false);
							...
							if (cb[8].isSelected()) {
								JMenuItem jMenu0_3 = (JMenuItem) popup0.add(new JMenuItem(lang[32]));
								...
								JMenuItem jMenu0_3 = (JMenuItem) popup0.add(new JMenuItem(lang[31]));
								jMenu0_3.addActionListener(new ActionListener() {
									public void actionPerformed(ActionEvent e) {
							...
							if (!cb[9].isSelected()) {
								JMenuItem jMenu0_4 = (JMenuItem) popup0.add(new JMenuItem(lang[37]));
								...
								JMenuItem jMenu0_4 = (JMenuItem) popup0.add(new JMenuItem(lang[35]));
								jMenu0_4.addActionListener(new ActionListener() {
									public void actionPerformed(ActionEvent e) {
						...
						case 1:
							...
							if (A.AgentisFreezed()) {
								JMenuItem jMenu1_1 = (JMenuItem) popup1.add(new JMenuItem(lang[36]));
								...
								JMenuItem jMenu1_1 = (JMenuItem) popup1.add(new JMenuItem(lang[34]));
								jMenu1_1.addActionListener(new ActionListener() {
									public void actionPerformed(ActionEvent e) {
							...
							if (!A.getClasse().equals("")) {
								JMenuItem jMenu1_2 = (JMenuItem) popup1.add(new JMenuItem(lang[38]));
							...
							try {
								...
								if (Vinit != null && Vinit.size() != 0) {
									...
									for (int i = 0; i < Vinit.size(); i++) {
										...
										JMenuItem jMenu1_5 = (JMenuItem) Initializers.add(new JMenuItem(init));
						...
						case 4:
							...
							JMenuItem jMenu4_1 = (JMenuItem) popup4.add(new JMenuItem(lang[41]));
							...
							JMenuItem jMenu4_2 = (JMenuItem) popup4.add("reverse arrows");
	...
	class Tree {
		private Vector VAgents, VLinks, VSpecialLinks, VSelected, preselect;
		private GraphicAgent Parent;
		private GraphicLink lselectionne;
		private int selected, num, abs, ord, L, l, decalX, decalY;
		private boolean isModified = false, SmallIcons = false;
		private TreeDrawing TD;
		...
		public void setIcon(GraphicAgent agent, String classename) {
			...
			if ((new File(IconFilename)).exists()) {
				...
				if (cb[4].isSelected() && dessin != null)
					agent.setIconVisible(true);
				else
					agent.setIconVisible(false);
			} else {
				if (SmallIcons)
		...
		public void savePreviousSelection() {
			...
			for (int i = 0; i < VSelected.size(); i++)
				preselect.add((GraphicAgent) VSelected.elementAt(i));
		}
		...
		public void setSelection(String computer) {
			...
			for (int i = 0; i < VAgents.size(); i++) {
				if (((GraphicAgent) VAgents.elementAt(i)).getComputer().toLowerCase().equals(computer)) {
					VSelected.add((GraphicAgent) VAgents.elementAt(i));
					selected = 1;
				}
			}
		...
		public void setPreviousSelection() {
			...
			for (int i = 0; i < preselect.size(); i++) {
				VSelected.add((GraphicAgent) preselect.elementAt(i));
				selected = 1;
			}
			AgentProperties.setName(getName());
			AgentProperties.setClass(getClasse());
