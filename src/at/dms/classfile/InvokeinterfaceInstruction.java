    ...
    extends Instruction
{
     ...
     * @param nargs  number of arguments
     */
    public InvokeinterfaceInstruction(String owner,
                                      String name, String type, int nargs)
    {
        super(opc_invokeinterface);
    ...
    public byte getReturnType() {
        ...
        default:
            throw new InternalError("invalid signature " + type);
        }
    }
    ...
    public int getPushedOnStack() {
        ...
        case 'J':
            return 2;
        default:
            throw new InternalError("invalid signature x" + type);
        } 
    }
