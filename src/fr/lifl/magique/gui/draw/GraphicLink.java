...
public class GraphicLink {
     ...
     */
    public boolean contains(GraphicAgent target) {
        return (target == Parent || target == Child);
    }
    ...
    public void delete() {
        if (!isDirect) {
            ...
            Child.removeSpecialParent(Parent);
            Parent.removeSpecialChild(Child);
        }
    }
    ...
    public boolean equals(GraphicLink l) {
        return l.GetParent() == Parent && l.getChild() == Child;
    }

    public boolean compare(GraphicLink l) {
        GraphicAgent childtmp = l.getChild();
        GraphicAgent parenttmp = l.GetParent();
        return childtmp.getName().equals(Child.getName()) && parenttmp.getName().equals(Parent.getName())
